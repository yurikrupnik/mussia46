...
#BucketObjectInitParameters: {
	...
	retention?: [...#RetentionInitParameters] @go(Retention,[]RetentionInitParameters)
...
#BucketObjectObservation: {
	...
	// The object retention settings for the object. The retention settings allow an object to be retained until a provided date. Structure is documented below.
	retention?: [...#RetentionObservation] @go(Retention,[]RetentionObservation)
...
#BucketObjectParameters: {
	...
	// The object retention settings for the object. The retention settings allow an object to be retained until a provided date. Structure is documented below.
	// +kubebuilder:validation:Optional
	retention?: [...#RetentionParameters] @go(Retention,[]RetentionParameters)
...
#RetentionInitParameters: {
	...
	retainUntilTime?: null | string @go(RetainUntilTime,*string)
}
