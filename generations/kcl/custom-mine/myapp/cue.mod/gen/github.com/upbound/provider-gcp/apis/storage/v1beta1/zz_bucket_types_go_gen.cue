...
#AutoclassInitParameters: {
	...
	terminalStorageClass?: null | string @go(TerminalStorageClass,*string)
}
...
#BucketInitParameters: {
	...
	enableObjectRetention?: null | bool @go(EnableObjectRetention,*bool)
	...
	softDeletePolicy?: [...#SoftDeletePolicyInitParameters] @go(SoftDeletePolicy,[]SoftDeletePolicyInitParameters)
...
#BucketObservation: {
	...
	// A map of key/value label pairs to assign to the bucket.
	// +mapType=granular
	effectiveLabels?: {[string]: null | string} @go(EffectiveLabels,map[string]*string)
	...
	// is not provided, the provider project is used.
	project?:       null | string  @go(Project,*string)
	projectNumber?: null | float64 @go(ProjectNumber,*float64)
	...
	// The bucket's soft delete policy, which defines the period of time that soft-deleted objects will be retained, and cannot be permanently deleted. Structure is documented below.
	softDeletePolicy?: [...#SoftDeletePolicyObservation] @go(SoftDeletePolicy,[]SoftDeletePolicyObservation)
	...
	// A map of key/value label pairs to assign to the bucket.
	// +mapType=granular
	terraformLabels?: {[string]: null | string} @go(TerraformLabels,map[string]*string)
...
#BucketParameters: {
	...
	// The bucket's soft delete policy, which defines the period of time that soft-deleted objects will be retained, and cannot be permanently deleted. Structure is documented below.
	// +kubebuilder:validation:Optional
	softDeletePolicy?: [...#SoftDeletePolicyParameters] @go(SoftDeletePolicy,[]SoftDeletePolicyParameters)
...
#ConditionInitParameters: {
	...
	sendAgeIfZero?: null | bool @go(SendAgeIfZero,*bool)
	...
	sendDaysSinceCustomTimeIfZero?: null | bool @go(SendDaysSinceCustomTimeIfZero,*bool)
	...
	sendDaysSinceNoncurrentTimeIfZero?: null | bool @go(SendDaysSinceNoncurrentTimeIfZero,*bool)
	...
	sendNumNewerVersionsIfZero?: null | bool @go(SendNumNewerVersionsIfZero,*bool)
...
#SoftDeletePolicyInitParameters: {
	...
	retentionDurationSeconds?: null | float64 @go(RetentionDurationSeconds,*float64)
}

#SoftDeletePolicyObservation: {
	...
	effectiveTime?: null | string @go(EffectiveTime,*string)

	// The duration in seconds that soft-deleted objects in the bucket will be retained and cannot be permanently deleted. Default value is 604800. The value must be in between 604800(7 days) and 7776000(90 days). Note: To disable the soft delete policy on a bucket, This field must be set to 0.
	retentionDurationSeconds?: null | float64 @go(RetentionDurationSeconds,*float64)
}

#SoftDeletePolicyParameters: {
	// The duration in seconds that soft-deleted objects in the bucket will be retained and cannot be permanently deleted. Default value is 604800. The value must be in between 604800(7 days) and 7776000(90 days). Note: To disable the soft delete policy on a bucket, This field must be set to 0.
	// +kubebuilder:validation:Optional
	retentionDurationSeconds?: null | float64 @go(RetentionDurationSeconds,*float64)
}
